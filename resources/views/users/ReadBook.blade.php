...
@section('main')
    ...
    <div class="col s12 m12 l12">
                              ...
                              <div class="pdf">
                                 <embed class="col s12 m12 l12" src="{{ asset('book')}}/{{ $book->books_file }}#zoom=100&toolbar=0&navpanes=0;" type="application/pdf" width="100%" height="800px"/>

                                <!--<object class="col s12 m12 l12" data="{{ asset('book')}}/{{ $book->books_file }}#zoom=100&toolbar=0" type="application/PDF" width="100%" height="800px" align="right"></object>-->
