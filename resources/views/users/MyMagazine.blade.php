                ...
                <div class="col-lg-3 col-md-3 col-sm-3 mb">
                    <div class="movie-card">
                        <div id="movie-header" style="">
                          <a href="{{url('ShowMyReadMegazine/'.$Megazine->id)}} style="color: #ffff"">
                            @if($Megazine->cover)
                                <img src="{{asset($Megazine->cover)}}" width="100%" height="220" style="">
                            @else
                        ...
                        <div class="movie-content">
                            <center><h4>{{$Megazine->title}}</h4></center>
                            <h6><b>Proveedor:</b> {{$Megazine->Seller->name}}</h6>
                            <h6 class="sinopsis"><b>Sinopsis:</b>{{$Megazine->descripcion}}
                            </h6>
