...
<div class="row">
  <div class="col s12 m12">
   ...
   <div id="listaBeneficios" class="col s12 center">
      <ul class="tabs">
          <li class="tab col s6"><a class="active" href="#test01">Productos pendientes</a></li>
           ...
           <div  class="col m4 s6 ">
                <div class="card">
                    ...
                    <div class="card-action">
                        <span>Disponible: {{$bene->amount}} </span><br><br>
           ...
           <div  class="col m4 s6 ">
                <div class="card">
                    <div class="card-image"> 
                        ...
                        <img  src="{{asset($produc->Producto->imagen_prod)}}">
