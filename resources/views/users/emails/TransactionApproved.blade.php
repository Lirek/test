...
<table class="wrapper" width="100%" cellpadding="0" cellspacing="0">
 ...
 <tr>
	<td>
		<p style="font-size: 14px;" align="justify">{{ $user->name }} {{ $user->last_name }}, ahora que cuentas con más tickets disponibles le invitamos a consumir cualquiera de nuestros productos en LEIPEL.</p>
 	</td>
 </tr>
 <tr>
	<td>
