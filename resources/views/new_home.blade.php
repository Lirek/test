  ...
  <html>
    <head>
      ...
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.100.2/css/materialize.min.css">
       ...
       <link rel="stylesheet" href="{{asset('sistem_images/MaterialAdmin.css')}}">
...
<nav>
    <div class="nav-wrapper">
      ...
      <a href="{{url('/home')}}" class="brand-logo center"><img src="{{ asset('sistem_images/Logo-Leipel.png') }}" class="img-responsive" style="width:35%;"></a>
       <ul class="right hide">
      @if (Auth::guest())      
