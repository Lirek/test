...
@section('content')
    ...
    <div class="row">
      <center>
             ...
             <div class="col-md-4 zoom"> 
                <a class="button" href="{{url('MusicContent')}}"><img src="{{asset('sistem_images/logo-icon-4.png')}}" width="200" height="150" alt=""></a></div>

             <div class="col-md-4 zoom" style="margin-bottom: 15px">   
                <a class="button" href="{{url('ReadingsBooks')}}"><img src="{{asset('sistem_images/logo-icon.png')}}" width="200" height="150" alt=""></a></div>
              <div class="col-md-4 zoom">
