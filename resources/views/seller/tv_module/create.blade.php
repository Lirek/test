            ...
            <div class="box box-primary ">
                ...
                <div class="box-body ">
                    <div class="form-group">
                        <label for="exampleInputFile" class="control-label">Nombre de la canal</label>
                        {!! Form::text('name_r',null,['class'=>'form-control','placeholder'=>'nombre de la Tv'],['id'=>'exampleInputFile']) !!}
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="control-label">Url de la canal</label>
                        {!! Form::text('streaming',null,['class'=>'form-control','placeholder'=>'url de la Tv'],['id'=>'exampleInputFile']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile">Logo de la canal</label>
