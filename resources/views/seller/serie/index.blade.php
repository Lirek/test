...
<div class="row">
    <div class="col s12 m12">
        ...
        <div class="card-panel curva">
                ...
                <div class="col s12 m3">
                  <div class="card">
                    <div class="card-image">
                        <a href="{{ route('series.show',$m->id) }}">
                      <img src="{{ asset($m->img_poster)}}" width="100%" height="300px">
                      </a>
                      <!-- <span class="card-title">Card Title</span> -->
                      <a class="btn-floating halfway-fab waves-effect waves-light blue" href="{{ route('series.edit',$m->id) }}"><i class="material-icons">create</i></a>
                    </div>
            ...
            <a href="{{ route('series.create') }}" class="btn curvaBoton waves-effect waves-light green">   
