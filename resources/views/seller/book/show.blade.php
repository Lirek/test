                ...
                <div class="box box-widget widget-user-2">
                    ...
                    <div class="widget-user-header bg-navy">
                        <div class="widget-user-image">
                            <img class="img-rounded img-responsive av" src="/images/authorbook/{{ $book->author->photo}}"
                    ...
                    <div class="box-footer no-padding">
                        <ul class="nav nav-stacked">
                            <li style="height: 90px"><a href="#">Libro
                            ...
                            <li><a href="#">Titulo original <span class="pull-right ">{{ $book->original_title }}</span></a></li>
                            <li><a href="#">Saga <span class="pull-right ">{{ $book->saga->sag_name }}</span></a></li>
                            <li><a href="#">Sinopsis <span class="pull-right ">{{ $book->sinopsis }}</span></a></li>
                        </ul>
                    </div>
                </div>
