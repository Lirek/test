                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="col s12 m6">
                                ...
                                <i class="material-icons prefix blue-text valign-wrapper">local_play</i>
                                    ...
                                    @if($i_megazine->status != 'Aprobado')
                                        {!! Form::number('cost',$i_megazine->cost,['class'=>'form-control', 'required'=>'required', 'oninvalid'=>"this.setCustomValidity('Escriba un costo en tickets')", 'oninput'=>"setCustomValidity('')", 'id'=>'precio', 'min'=>'0']) !!}
