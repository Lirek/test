    ...
    <div class="card-panel curva">
                                ...
                                <div class="file-field input-field">
                                    ...
                                    <br><br>
                                        ...
                                        <div class="btn blue">
                                            ...
                                            {!! Form::file('pdf_file',['class'=>'form-control','accept'=>'.pdf','control-label','placeholder'=>'Cargar la revista','required'=>'required','oninvalid'=>"this.setCustomValidity('Seleccione el documento del revista')",'oninput'=>"setCustomValidity('')",'id'=>'revista']) !!}
        ...
        <div class="">
            ...
            <div class="text-center">
                {!! Form::submit('Registrar revista', ['class' => 'btn btn-primary curvaBoton green','id'=>'guardarRevista']) !!}
            </div>
        </div>
        </form>
    </div>
