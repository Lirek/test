...
<html>
	<body>
		<table class="wrapper" width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td align="center">
					<h1>Su CADENA DE PUBLICACIÓN ha sido APROBADA.</h1>
				</td>
			</tr>
			...
			<tr>
				<td>
					<p style="font-size: 14px;" align="justify">
						Hola, nos complecemos en informarle que su CADENA DE PUBLICACIÓN: "{{$title}}" ha sido APROBADA y desde ya podrá ser disfrutada por todas las personas que conforman la comunidad LEIPEL.
					</p>
				</td>
			</tr>
