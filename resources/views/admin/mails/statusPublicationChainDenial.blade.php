...
<html>
	<body>
		<table class="wrapper" width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td align="center">
					<h1>Su CADENA DE PUBLICACIÓN ha sido RECHAZADA.</h1>
				</td>
			</tr>
			...
			<tr>
				<td>
					<p style="font-size: 14px;" align="justify">
						Hola, de parte de LEIPEL le informamos que su CADENA DE PUBLICACIÓN: "{{$title}}" fue rechazada por el siguiente motivo:
					</p>
				</td>
			</tr>
