...
<main  class="mdl-layout__content">
 ...
 <div class="mdl-grid">
    ...
    <div class="mdl-card__media">
      <img src="{{asset('sistem_images/university.png')}}" width="300" height="200" border="0" alt="" style="padding:20px;">
    </div>
  
  <div class="mdl-card__supporting-text">
    <p>
    @if(count($megazines) != 0 or count($books) != 0) 
    Existen {{count($megazines)}} Revistas Pendientes de aprobacion 
    y Existen {{count($books)}} Libros Pendientes de aprobacion
    @else
        ...
        <div class="mdl-card">
            <div class="mdl-card__title">
              <h2 class="mdl-card__title-text">Contenido AudioVisual</h2>
                ...
                <div class="mdl-card__media">
                    <img src="{{asset('sistem_images/filmografa.png')}}" width="300" height="200" border="0" alt="" style="padding:20px;">
                </div>
                    <div class="mdl-card__supporting-text">
    ...
    <div class="mdl-cell--4-col">
        <div class="mdl-card">
            <div class="mdl-card__title">
                ...
                <div class="mdl-card__media">
                    <img src="{{asset('sistem_images/music.png')}}" width="300" height="200" border="0" alt="" style="padding:20px;">
                </div>
            <div class="mdl-card__supporting-text">
