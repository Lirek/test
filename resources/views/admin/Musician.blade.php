            ...
            <div class="mdl-cell mdl-cell--4-col">
                    ...
                    <table class="mdl-data-table mdl-js-data-table ">            
                        <thead>
                                ...
                                <tbody>
                                    @foreach($musician as $author)
                                    <tr id="author{{$author->id}}">
                                      <td>{{$author->id}}</td>
                                      <td>{{$author->name}}</td>

                                      <td>
                                        <img class="img-rounded img-responsive av" src="{{$author->photo}}"
                                 style="width:70px;height:70px;" alt="User Avatar">
                                      </td>

                                      <td><p>{{$author->descripcion}}</p></td>
                                      
                                      <td>{{$author->Seller()->first()->name}}</td>
                                      <td>
                                       
                                        <a target="_blank" href="http://{{$author->facebook}}">
                                       <button id="menu-speed" class="mdl-button mdl-js-button mdl-button--icon">
                                          <i class="fa fa-facebook"></i>
                                       </button>
                                       </a>

                                       <a target="_blank" href="http://{{$author->google}}">
                                       <button id="menu-speed" class="mdl-button mdl-js-button mdl-button--icon">
                                          <i class="fa fa-youtube"></i>
                                       </button>
                                       </a>

                                       <a target="_blank" href="http://{{$author->instagram}}">
                                       <button id="menu-speed" class="mdl-button mdl-js-button mdl-button--icon">
                                          <i class="fa fa-instagram"></i>
                                       </button>
                                       </a>

                                       <a target="_blank" href="http://{{$author->twitter}}">
                                       <button id="menu-speed" class="mdl-button mdl-js-button mdl-button--icon">
                                      ...
                                      <td>
                                        <button class="mdl-button mdl-js-button mdl-button--primary" id="status" value="{{$author->id}}" data-toggle="modal" data-target="#myModal">
                                                        {{$author->status}}
                                        </button>
