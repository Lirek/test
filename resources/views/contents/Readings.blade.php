                			...
                			<div class="col-lg-3 col-md-3 col-sm-3 mb" style="margin-top: 2%">
                                ...
                                <a href="#" data-toggle="modal" data-target="#myModal-{{$Book->id}}" style="color: #ffff">
                                  ...
                                  <h6><b>Costo:</b> {{$Book->cost}} tickets</h6>
                            			<center><a href="#" class=""  id="modal-confir.{{$Book->id}}" onclick="fnOpenNormalDialog('{!!$Book->cost!!}','{!!$Book->title!!}','{!!$Book->id!!}')"><b>Adquirir</b></a></p></center>
								 ...
								 <div id="myModal-{{$Book->id}}" class="modal fade" role="dialog">
                                    ...
                                    <h5> <b>Géneros:</b>
                                        ...
                                        @endforeach
                            					...
                            					<!-- /.widget-user-image -->
                            					<h5 class="widget-user-username"><b>Autor:</b> <a href="ProfileBookAuthor/{{$Book->id}}">{{ $Book->author->full_name }}</a></h5>
                        						<hr>
                    						</div>
                    							</div>
                    						<div class="">
