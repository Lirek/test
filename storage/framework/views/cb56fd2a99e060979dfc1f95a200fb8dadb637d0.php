                ...
                <div class="row ">
                    <?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card">
                            ...
                            <a href="<?php echo e(route('authors_books.showBooks', $author->id)); ?>">
                              <img src="<?php echo e(asset('images/authorbook')); ?>/<?php echo e($author->photo); ?>" width="100%" height="300px">
                              </a>
                              <!-- <span class="card-title">Card Title</span> -->
                                <a class="btn-floating halfway-fab waves-effect waves-light blue" href="<?php echo e(route('authors_books.edit', $author->id)); ?>"><i class="material-icons">create</i></a>
                            </div>
                            <div class="card-content">
                                <div class="col m12">
                                    <p class=""><?php echo e($author->full_name); ?> </p>
                                </div>
                                <div class="col m12 ">
                                    <small><b>Email:</b> <?php echo e($author->email_c); ?></small>
                                </div>
                                <div class="col m12 ">  
                                    <?php if($author->instagram!=null): ?>
                                            <div class="col m4 "> 
                                                <a href="<?php echo e($author->instagram); ?>" target="_blank">
                                                    <h5>
