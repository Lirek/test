...
<html lang="<?php echo e(app()->getLocale()); ?>">
    ...
    .row .input-field input:focus {
     ...
     .sidenav .user-view  {
         background-image: url(<?php echo e(asset("/plugins/materialize_adm/img/user-background-verde.jpg")); ?>);
     }
        </style>
    ...
    <body>
            ...
            <ul id="slide-out" class="sidenav sidenav-fixed">
                ...
                <li><a href="<?php echo e(url('seller_edit')); ?>" class="waves-effect waves-green"><i class="small material-icons">person</i>Mi Perfil</a></li>
                    <li><div class="divider"></div></li>
                <li><a href="<?php echo e(url('SellerRequest')); ?>" class="waves-effect waves-green "><i class="small material-icons">attach_money</i>Retiro de fondo</a></li>
...
<!-- //////////////////////////////////////////////////////////// END  contenidos ////////////////////////////////////////-->
            ...
            <?php else: ?>
                         ...
                         <!--    <li>
                            ...
                            <li>
                                <a href="<?php echo e(url('/seller_logout')); ?>" class="waves-effect waves-green" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="small material-icons">power_settings_new</i>Salir</a></a>
                                <form id="logout-form" action="<?php echo e(url('/seller_logout')); ?>" method="POST" style="display: none;">
                                    <?php echo e(csrf_field()); ?>
            ...
            <div id="myModalTotal" class="modal modal-s" >
                ...
                <div class=" green"><br>
                   <h4 class="center white-text" ><i class="small material-icons">timeline</i> Mi Balance</h4>
                    ...
                    <h5 class="grey-text"><b>Total de tickets ganados:</b> <?php echo e(Auth::guard('web_seller')->user()->credito); ?></h5>
