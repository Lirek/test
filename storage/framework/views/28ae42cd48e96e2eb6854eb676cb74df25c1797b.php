<?php $__env->startSection('main'); ?>
    ...
    <?php echo $__env->make('promoter.modals.BookAuthorViewModals', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
    	function autoresLiterarios(status) {
            ...
            $.ajax({
                url: "<?php echo url('autoresLiterariosData'); ?>/"+status,
                type:'GET',
                dataType: "json",
                success: function (data) {
                    ...
                    $.each(data,function(i,info) {
                    	if (info.photo!=null) {
                    		var foto = 
                    		"<img class='materialboxed' src='<?php echo asset('/images/authorbook/"+info.photo+"'); ?>' style='width:70px;height:70px;' alt=Foto>";
                    	} else {
        ...
        $(document).on('click', '#status', function() {
            ...
            $("#formStatus").on('submit', function(e) {
                ...
                var url = "<?php echo e(url('statusBookAuthor/')); ?>/"+x;
        ...
        $(document).on('click', '#rejectAuthorBook', function(e) {
            ...
            var url = "<?php echo url('viewRejection/"+idAuthor+"/"+modulo+"'); ?>";
            console.log(url);
            $("#negaciones").empty();
            e.preventDefault();
            $.ajax({
