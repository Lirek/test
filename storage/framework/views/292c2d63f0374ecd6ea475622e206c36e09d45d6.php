            ...
            <div class="row">
                ...
                <div class="col s12 m12">
                    ...
                    <div class="input-field col s12 m6">
                        ...
                        <?php if($movie->status != 'Aprobado'): ?>
                            <?php echo Form::text('title',$movie->title,['class'=>'form-control','required'=>'required','id'=>'titulo','oninvalid'=>"this.setCustomValidity('Seleccione un título')",'oninput'=>"setCustomValidity('')"]); ?>

                        <?php else: ?>
                            <?php echo Form::text('title',$movie->title,['class'=>'form-control', 'readonly']); ?>
                    ...
                    <div class="input-field col s12 m6">
                        ...
                        <?php if($movie->status != 'Aprobado'): ?>
                            <?php echo Form::text('original_title',$movie->original_title,['class'=>'form-control','placeholder'=>'Titulo original','id'=>'titulOriginal','required'=>'required','oninvalid'=>"this.setCustomValidity('Seleccione el título original')",'oninput'=>"setCustomValidity('')"]); ?>

                        <?php else: ?>
                            <?php echo Form::text('original_title',$movie->original_title,['class'=>'form-control', 'readonly']); ?>
                    ...
                    <div class="input-field col s12 m3">
                        ...
                        <?php if($movie->status != 'Aprobado'): ?>
                            <?php echo Form::number('cost',$movie->cost,['class'=>'form-control','placeholder'=>'Costo en tickets', 'required'=>'required', 'oninvalid'=>"this.setCustomValidity('Escriba un Precio')", 'oninput'=>"setCustomValidity('')", 'id'=>'precio', 'min'=>'0' ,'max'=>'999' ,'oninput'=>"maxLengthCheck(this)"]); ?>
                ...
                <div class="col m12 s12">
                    ...
                    <div class="input-field col s12 m6">
                        ...
                        <?php else: ?>
                            <?php echo Form::select('rating_id',$ratin,$movie->rating_id,['class'=>'form-control select-author','placeholder'=>'Selecione una opción','id'=>'categoria','disabled'=>true ]); ?>
                    ...
                    <div class="input-field col s12 m6">
                        ...
                        <?php echo Form::textarea('based_on',$movie->based_on,['class'=>'materialize-textarea','rows'=>'3','cols'=>'2','placeholder'=>'Sinopsis de la película','required'=>'required', 'oninvalid'=>"this.setCustomValidity('Escriba una sinopsis de la película')", 'oninput'=>"setCustomValidity('')", 'id'=>'sinopsis']); ?>
                ...
                <div class="col m12 s12">
                    <a href="<?php echo e(url('/movies')); ?>" class="btn curvaBoton waves-effect waves-light red">Atrás</a>
                     <!-- <?php echo Form::submit('Editar película', ['class' => 'btn curvaBoton waves-effect waves-light green','id'=>'guardarCambios']); ?> -->
