...
<script>
  function solicitud(status) {
    ...
    if (status=="En Proceso") {
      var ruta = "<?php echo e(url('SellerApplyDataTable/En Proceso')); ?>";
    } else if (status=="Denegado") {
      var ruta = "<?php echo e(url('SellerApplyDataTable/Denegado')); ?>";
    }
    $.ajax({
      url: ruta,
      type:'GET',
  ...
  $(document).on('click', '#statusApplys', function() {
    ...
    $("#formStatus").on('submit', function(e) {
      ...
      var url = "<?php echo e(url('AdminAproveOrDenialApplys/')); ?>/"+x;
...
/*
  var proveedoresPendientes = $('#proveedoresPendientes').DataTable({
    ...
    ajax: '<?php echo url('SellerApplyDataTable/En Proceso'); ?>',
    columns: [
  ...
  */  
  ...
  $(document).on('click','#opcion2', function() {
    ...
    var proveedoresPendientes = $('#proveedoresPendientes').DataTable({
      ...
      ajax: '<?php echo url('SellerApplyDataTable/Denegado'); ?>',
      columns: [
        {data: 'nombreComercial', name: 'nombreComercial'},
        {data: 'nombreContacto', name: 'nombreContacto'},
        {data: 'telefono', name: 'telefono'},
