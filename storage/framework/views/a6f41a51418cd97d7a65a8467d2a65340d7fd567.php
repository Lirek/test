                    ...
                    <ul class="collapsible popout">
                        <li>
                            ...
                            <?php if(Auth::user()->points): ?>
                                ...
                                <div class="collapsible-body"> <a class="btn-floating btn-large deep-orange lighten-2 "> <b><?php echo e(Auth::user()->points); ?></b></a><br><br></div>
                            <?php else: ?>
                                <div class="collapsible-header center" style="display: block; border-bottom: 0px solid #ddd;"><h6>Total de puntos:</h6></div>
                        ...
                        <li class="active">
                            ...
                            <div class="collapsible-body"><a class="btn-floating btn-large  blue lighten-2"><b><?php echo e(Auth::user()->credito); ?></b></a><br><br></div>
                        </li>
                        ...
                        <li>
                            <?php if(Auth::user()->pending_points): ?>
                                ...
                                <div class="collapsible-body">  <a class="btn-floating btn-large  amber lighten-2"> <b> <?php echo e(Auth::user()->pending_points); ?></b></a><br><br></div>
                            <?php else: ?>
                                <div class="collapsible-header center" style="display: block; border-bottom: 0px solid #ddd; "><h6>Total de puntos pendientes:</h6></div>
