        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="box box-primary ">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?php echo Form::open(['route'=>'tbook.store', 'method'=>'POST','files' => 'true' ]); ?>
                    ...
                    <div class="box-body ">
                        ...
                        <div id="image-preview" style="border:#646464 1px solid ;" class="form-group col-md-1">
                            ...
                            <?php echo Form::file('cover',['class'=>'form-control-file','control-label','id'=>'image-upload'],['style'=>'border:#000000','1px solid ;']); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <br/>
                            <?php echo Form::select('author_id',$author,null,['class'=>'form-control select-author','placeholder'=>'selecione autor del libro'],['id'=>'exampleInputFile']); ?>
                            ...
                            <?php echo Form::text('original_title',null,['class'=>'form-control','placeholder'=>'Titulo del libro']); ?>
                            ...
                            <?php echo Form::file('books_file',['class'=>'form-control-file','control-label']); ?>

                            <br/>

                            
                            <label for="exampleInputPassword1" class="control-label">Sinopsis</label>
                            <?php echo Form::textarea('sinopsis',null,['class'=>'form-control','rows'=>'3','cols'=>'2','placeholder'=>'Sinopsis del libro...'],['id'=>'exampleInputFile']); ?>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="" style="display:none" id="if_si">
                                ...
                                <?php echo Form::select('saga_id',$saga,null,['class'=>'form-control select-saga','placeholder'=>'selecione saga de libro','id'=>'sagas'],['id'=>'sagas']); ?>
                                ...
                                <?php echo Form::number('after',null,['class'=>'form-control','placeholder'=>'discusion sobre este campo y si queda debe ser tipo text...'],['id'=>'exampleInputFile']); ?>


                                
                                <label for="exampleInputPassword1" class="control-label">Antes</label>
                                <?php echo Form::number('before',null,['class'=>'form-control','placeholder'=>'discusion sobre este campo y si queda debe ser tipo text...'],['id'=>'exampleInputFile']); ?>
                            ...
                            <?php echo Form::number('cost',null,['class'=>'form-control','placeholder'=>'50'],['id'=>'exampleInputFile']); ?>
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="box-body ">
                            ...
                            <div id="imageAM-preview" style="border:#646464 1px solid ;" class="form-group col-md-1">
                                ...
                                <?php echo Form::file('photo',['class'=>'form-control-file','control-label','id'=>'imageAM-upload'],['style'=>'border:#000000','1px solid ;']); ?>
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <?php echo Form::text('full_name',null,['class'=>'form-control autofocus','placeholder'=>'nombre completo del autor'],['id'=>'exampleInputFile']); ?>
