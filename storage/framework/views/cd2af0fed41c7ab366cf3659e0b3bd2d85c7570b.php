...
<html lang="<?php echo e(app()->getLocale()); ?>">
    <head>
        ...
        <style>
            ...
            .sidenav .user-view  {
                background-image: url(<?php echo e(asset("/plugins/materialize_adm/img/user-yellow-background.jpg")); ?>);
            }
        </style>
            ...
            <div class="navbar-fixed" >
                <nav class="amber">
                    <div class="nav-wrapper">
                        ...
                        <!-- Logo principal -->
                        <a href="<?php echo e(url('/bidder_home')); ?>" class="brand-logo left logo-adjust">
            ...
            <ul id="slide-out" class="sidenav sidenav-fixed">
                <li><!--Seccion de usuario -->
                    <div class="user-view">
                        <div class="container">
                            <a href="#">
                                <?php if(Auth::guard('bidder')->user()->logo!=null): ?>
                                    <img src="<?php echo e(asset(Auth::guard('bidder')->user()->logo)); ?>" alt="Avatar" class=" z-depth-3 responsive-img circle logo-container img-perfil">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('sistem_images/DefaultUser.png')); ?>" alt="Avatar" class=" z-depth-3 responsive-img circle logo-container img-perfil">
                                <?php endif; ?>
                            </a><!-- logo user default -->
                        </div>
                        <div class="info-container">
                            <div class="name">
                                <a class="white-text" href="#"><?php echo e(Auth::guard('bidder')->user()->name); ?></a>
                            </div>
                            <div class="name">
                                <a class="modal-trigger white-text valign-wrapper" href="#myModalTotal">
                                    <i class="material-icons ">bubble_chart</i> Puntos ganados: <?php echo e(Auth::guard('bidder')->user()->points); ?>
                ...
                <li>
                    <a href="<?php echo e(url('retiro')); ?>" class="waves-effect waves-yellow">
                        <i class="small material-icons">attach_money</i>
                        Retiro de fondo
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('allProducts')); ?>" class="waves-effect waves-yellow">
                        <i class="small material-icons">shopping_basket</i>Mis productos
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('bidderLogout')); ?>" class="waves-effect waves-yellow">
        ...
        <div id="myModalTotal" class="modal modal-s">
            <div class="modal-content">
                ...
                <blockquote class="center">
                    <h5 class="grey-text"><b>Total de puntos ganados:</b> <?php echo e(Auth::guard('bidder')->user()->points); ?></h5>
                    <h5 class="grey-text"><b>Total de puntos pendientes:</b> <?php echo e(Auth::guard('bidder')->user()->pendding_points); ?></h5>
                    <h5>
