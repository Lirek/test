...
<div class="row">
    <div class="col s12 m12">
        ...
        <div class="card-panel curva">
            <h4 class="titelgeneral"><i class="mdi mdi-filmstrip"></i>"<?php echo e($movie->title); ?>" (<?php echo e($movie->release_year); ?>) </h4>
            <br>
            <div class="row">
                <div class="col s12 m4">
                    <img src="<?php echo e(asset('movie/poster')); ?>/<?php echo e($movie->img_poster); ?>" width="100%" height="300" style="border-radius: 10px" id="panel" class="materialboxed">
                    <br><br>
                    ...
                    <ul class="collection z-depth-1" >
                        ...
                        <li class="collection-item" style="padding: 10px ">
                            <div class="row">
                                ...
                                <div class="col s12 m7">
                                    <?php echo e($movie->rating->r_name); ?>

                                </div>
                            </div>
                        </li>
                        <?php if($movie->saga!=null): ?>
                        <li class="collection-item" style="padding: 10px ">
                            <div class="row">
                                <div class="col s12 m5">
                                ...
                                <div class="col s12 m7">
                                    <?php echo e($movie->saga->sag_name); ?>
                        ...
                        <li class="collection-item" style="padding: 10px ">
                            <div class="row">
                                ...
                                <div class="col s12 m7">
                                    <a class="waves-effect waves-light btn modal-trigger blue curvaBoton" href="<?php echo e($movie->trailer_url); ?>" target="_blank">Reproducir</a>
                                </div>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="card blue accent-2">
                        <div class="card-content white-text center-align">
                            <p class="card-title">
                                ...
                                <?php echo e($movie->transaction->count()); ?>
...
<div id="modal-default" class="modal" >
    <div class="modal-content modal-lg">
        <div class=" blue"><br>
            <h4 class="center white-text" ><i class="small material-icons">movie</i>"<?php echo e($movie->title); ?>"</h4>
            <br>
        </div>
        <br>
        <div class="">
            <div class="col m12 s12">
                    <br>
                    <video style="width: 100%" poster="<?php echo e(asset('movie/poster')); ?>/<?php echo e($movie->img_poster); ?>" id="player" controls >
