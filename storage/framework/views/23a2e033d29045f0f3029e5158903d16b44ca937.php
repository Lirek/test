                ...
                success: function (data) {
                    ...
                    $.each(data,function(i,info) {
                        ...
                        if (info.status=="En Revision") {
                            var opcion = "<a class='btn curvaBoton' target='_blank' href='<?php echo asset('"+info.megazine_file+"'); ?>' href='#file' id='file_b'>Ver Revista</a> <button class='btn modal-trigger curvaBoton green' value='"+info.id+"' value2='En Revision' href='#myModal' id='status'>"+info.status+"</button><button class='btn modal-trigger curvaBoton red' value='"+info.id+"' value2='En Revision' href='#negado' id='denegadoRE'>ver negaciones</button>"
