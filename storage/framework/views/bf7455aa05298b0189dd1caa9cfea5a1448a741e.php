                ...
                <div class="col-lg-3 col-md-3 col-sm-3 mb">
                    <div class="movie-card" style="  border-radius: 10px;">
                        ...
                        <!-- <div class="profile-01 centered">
                            <p><a href="<?php echo e(url('ShowMyReadBook/'.$Book->id)); ?>" style="color: #ffff">Ver mas</p></a>
                        </div> -->
                        <div class="movie-content">
                            <center><a href="<?php echo e(url('ShowMyReadBook/'.$Book->id)); ?>" style="color: "><h4><?php echo e($Book->title); ?></h4></a></center>
                            <h6><b>Autor:</b><a href="ProfileBookAuthor/<?php echo e($Book->id); ?>"><?php echo e($Book->author->full_name); ?></a></h6>
                            <h6 class="sinopsis"><b>Sinopsis:</b><?php echo e($Book->sinopsis); ?>
