                ...
                <div class="col s12 m3">
                    <div class="card gradient-45deg-light-blue-cyan gradient-shadow" style="height: 150px">
                        <div class="padding-4" style="padding: 4%"> 
                            ...
                            <div class="col m7">
                                <h5 style="color: white"><b>Tickets Retirados:</b> <?php echo e($pagado); ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card" style="height: 320px">
                        ...
                        <h4 class="titelgeneral"> Solicitar retiro de fondos</h4>
                         ...
                         <div class="input-field col s12 m8 offset-m2">
                            ...
                            <input type="number" min="1" max="<?php echo e(Auth::guard('web_seller')->user()->credito); ?>" value="" class="" name="Cantidad" id="monto" required="required" value="<?php echo e(old('Cantidad')); ?>" onkeypress="return controltagNum(event)">
