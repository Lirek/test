  ...
  <div class="row mtbox" style="margin-top: 2%">
    <div class="col-sm-6 col-md-6">
        <div class="col-md-12 col-sm-12 mb" style="margin-left:">
            <div class="darkblue-panel pn">
                ...
                <div class="centered">
                    <h2 style="color: #fff"><?php echo e($referals1+$referals2+$referals3); ?></h2>
                </div>
                <footer><br>
      ...
      <?php endif; ?>
      <?php if($refered != null): ?>
        <h5 style="margin-left: 3%">Mis referidos directos: <span class="badge bg-info"><?php echo e($referals1); ?></span></h5>
                      ...
                      <div class="modal-body">
                          ...
                          <center>
                            <?php if($refereds->phone): ?>
                              <h5 style="margin-top: 2%"><b>Teléfono: </b> <?php echo e($refereds->phone); ?></h5>
                            <?php else: ?>
    ...
    <div class="col-sm-6 col-md-6">
      ...
      <div class="col-md-12 col-sm-12 text-center" style="margin-left: 1%; margin-top: 1%">
        <img src="<?php echo e(asset('prom ociones/PromocionGalapagosImg.jpg')); ?>" style="width: 80%;">
