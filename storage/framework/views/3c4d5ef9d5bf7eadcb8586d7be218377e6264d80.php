				...
				<div class="row">
					<div class="col s12 m3">
	                    <div class="card gradient-45deg-green-teal gradient-shadow" style="height: 150px">
	                        <div class="padding-4" style="padding: 4%">
	                            <div class="col s12">
	                               <h5 style="color: white"><b>Puntos disponibles:</b> <?php echo e(Auth::guard('bidder')->user()->points); ?></h5>
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                <div class="col s12 m3">
	                    <div class="card gradient-45deg-green-teal gradient-shadow" style="height: 150px">
	                        <div class="padding-4" style="padding: 4%">
	                            <div class="col s12">
	                               <h5 style="color: white"><b>Puntos pendientes:</b> <?php echo e(Auth::guard('bidder')->user()->pendding_points); ?></h5>
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                <div class="col s12 m3">
	                    <div class="card gradient-45deg-green-teal gradient-shadow" style="height: 150px">
	                        <div class="padding-4" style="padding: 4%">
	                            <div class="col s12">
	                               <h5 style="color: white"><b>Puntos por canjear:</b> <?php echo e($diferido); ?></h5>
	                            </div>
	                ...
	                <div class="col s12 m3">
	                    <div class="card gradient-45deg-green-teal gradient-shadow" style="height: 150px">
	                        <div class="padding-4" style="padding: 4%">
	                            <div class="col s12">
	                               <h5 style="color: white"><b>Puntos retirados:</b> <?php echo e($pagado); ?></h5>
	                            </div>
					...
					<div class="col s12 m6">
						...
						<div class="card" style="height: 320px">
							...
							<div class="input-field col s12 m8 offset-m2">
								...
								<input type="number" min="1" max="<?php echo e(Auth::guard('bidder')->user()->points); ?>" id="monto" required="required" value="<?php echo e(old('Cantidad')); ?>" onkeypress="return controltagNum(event)">
		...
		<div class="modal-content">
			...
			<div class="row">
				<div class="col s12">
					...
					<div class="col m12">
                        <form class="form-horizontal" action="<?php echo e(url('retirar')); ?>" method="post" enctype="multipart/form-data">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			if (<?php echo $status; ?>==1) {
				...
				.then((recarga) => {
        			location.replace("<?php echo e(url('retiro')); ?>");
        		});
			}
			if (<?php echo Auth::guard('bidder')->user()->points; ?> != 0) {
				$('#monto').val(<?php echo Auth::guard('bidder')->user()->points; ?>);
			} else {
		...
		$("#monto").change(function(){
			...
			if (nombre.length < 1 ){
				...
				$('#solicitar').attr('disabled',true);
			} else if (nombre > <?php echo Auth::guard('bidder')->user()->points; ?> ){
				$('#mensajeMonto').show();
        ...
        $("#solicitar").click(function(){
        	...
        	var subtotal=tickets*<?php echo $valorPunto; ?>;
        ...
        $(".status").click(function(e){
        	...
        	console.log(status);
        	var url = "<?php echo url('viewPayments/'); ?>/"+status;
        	console.log(url);
        	$("#payments").empty();
        	$("#titulo").empty();
        	e.preventDefault();
        		...
        		success: function(datos){
        			...
        			$.each(datos, function(i,info){
        				if (info.factura!=null ) {
							var factura = 
							"<img class='materialboxed' width='90' height='90' src='<?php echo asset('"+info.factura+"'); ?>'";
						} else {
