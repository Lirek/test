...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__currentLoopData = $author; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form  method="POST" action="<?php echo e(url('/save_modify_artist')); ?>" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>

            <input type="hidden" name="id" value="<?php echo e(Auth::guard('web_seller')->user()->id); ?>">
            <input type="hidden" name="id_author" value="<?php echo e($a->id); ?>">
            <div class="col-lg-12" style="margin-left: 30px; margin-right: 30px;">
                <div class="box box-primary">
                    <?php echo $__env->make('flash::message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <div class="box-header with-border"> 
                        <h3 class="box-title">Modificar <?php echo e($a->type_authors); ?></h3>
                    </div>
                        <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div id="image-preview" style="border:#bdc3c7 1px solid ;" class="col-md-1">
                                    ...
                                    <div id="list">
                                        <img style= "width:100%; height:100%; border-top:50%;" src="<?php echo e(asset($a->photo)); ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="col-md-12">
                                    ...
                                    <input id="art_name" type="text" value="<?php echo e($a->name); ?>" class="form-control" name="art_name" placeholder="Nombre del artista o agrupación" required="required" rows="3" cols="2" oninvalid="this.setCustomValidity('Inserte un nombre de artista o agrupacion valido')" oninput="setCustomValidity('')">   
                                    <br>
                                </div>
                                <div class="col-md-12">
                                    <label for="desc" class="control-label">Descripción</label>
                                    <div id="mensajeDescripcion"></div>
                                    <textarea class="form-control" name="dsc" placeholder="Descripción" id="descripcion" oninvalid="this.setCustomValidity('Inserte una descripción valida')" oninput="setCustomValidity('')"required="required"><?php echo e($a->descripcion); ?></textarea>
                                    <br>
                                </div>
                                <div class="col-md-12">
                                    <label for="type_authors" class="control-label">Tipo</label>
                                    <select class="form-control" name="type_authors" required="required">
                                        <option value="<?php echo e($a->type_authors); ?>"><?php echo e($a->type_authors); ?></option>
                                        <?php if($a->type_authors=='Solista'): ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input value="<?php echo e($a->google); ?>" type="text" class="form-control" id="google" name="google" placeholder="YouTube" pattern="http(s)?://(.*\.)?youtube\.com\/[A-z 0-9 /_]+\/?" oninvalid="this.setCustomValidity('Ingrese un canal valido')" oninput="setCustomValidity('')">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-instagram"></i></span>
                                        <input id="instagram" pattern="https?:\/\/(www\.)?instagram\.com\/[A-Za-z0-9_]+\/?" value="<?php echo e($a->instagram); ?>" type="text" name="instagram" class="form-control" placeholder="Instagram" oninvalid="this.setCustomValidity('Ingrese una cuenta de Instagram valido')" oninput="setCustomValidity('')">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-facebook-square"></i></span>
                                        <input value="<?php echo e($a->facebook); ?>" type="text" class="form-control" id="facebook" name="facebook" placeholder="Facebook" pattern="http(s)?:\/\/(www\.)?(facebook|fb)\.com\" oninvalid="this.setCustomValidity('Ingrese una cuenta de Facebook valida')" oninput="setCustomValidity('')" >
                                    </div>
