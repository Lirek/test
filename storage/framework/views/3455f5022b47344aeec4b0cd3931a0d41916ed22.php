...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('icon.ico')); ?>">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/login')); ?>">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <center><a class="btn btn-link" href="<?php echo e(url('/password/reset')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-12">
                                    <input id="name" type="text" class="form-control" name="name"
                                           value="<?php echo e(old('name')); ?>" placeholder="Nombre" required="required" onkeypress="return controltagLet(event)" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s]+">
                            ...
                            <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-12">
                                    <input id="emailRU" type="email" class="form-control" name="email"
                                           value="<?php echo e(old('email')); ?>" placeholder="Correo" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
