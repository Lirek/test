...
<div class="slider ">
    <ul class="slides">
        ...
        <li>
            <img src="<?php echo e(asset('plugins/materialize_index/img/slaider2.jpeg')); ?>" width="100%;" height="520px;"> <!-- random image -->
        </li>
        <li>
            <img src="<?php echo e(asset('plugins/materialize_index/img/slaider3.jpeg')); ?>" width="100%;" height="520px;"> <!-- random image -->
        </li>
    </ul>
</div>
<!-- FIN SLIDER  -->
    ...
    <?php $__currentLoopData = $radio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card">
                <div class="card-image ">
                    <img src="<?php echo e(asset($r->logo)); ?>" width="100%" height="200px">
...
<div class="row" id="Tvs">
    ...
    <?php $__currentLoopData = $tv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tvs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card">
                <div class="card-image ">
                    <img src="<?php echo e(asset($tvs->logo)); ?>"  width="100%" height="200px">
                    <a class="btn-floating halfway-fab waves-effect waves-light blue"><i class="material-icons">
                            remove_red_eye
                        </i></a>
                </div>
...
<div class="row">
    ...
    <div id="test1" class="col s12 center">
        ...
        <div class="col s12 m6 l6 xl6 center" ><br><br><br><br><br>
            <img src="<?php echo e(asset('plugins/materialize_index/img/youtube.png')); ?>" width="10%" height="10%" title="youtube"><br>
