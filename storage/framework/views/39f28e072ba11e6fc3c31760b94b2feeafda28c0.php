...
<div class="row">
    <div class="col s12 m12">
        ...
        <div class="card-panel curva">
            <h3 class="center">
                Registrar artista o agrupación musical
            </h3>
            <br>
            <div class="row">
                <form  method="POST" action="<?php echo e(url('/save_artist')); ?>" enctype="multipart/form-data">
                ...
                <div class="input-field col s12 m6">
                    ...
                    <input id="art_name" type="text" class="form-control" name="art_name"  required="required" rows="3" cols="2" oninvalid="this.setCustomValidity('Inserte un nombre de artista o agrupacion valido')" oninput="setCustomValidity('')">   
                    <br>
                </div>
                <div class="input-field col s12 m6">
                    <i class="material-icons prefix blue-text valign-wrapper">create</i>
                    <div id="mensajeDescripcion"></div>
                    <textarea class="materialize-textarea" name="dsc" id="descripcion" oninvalid="this.setCustomValidity('Inserte una descripción valida')" oninput="setCustomValidity('')"required="required"></textarea>
                ...
                <div class="input-field col s12 m6">
                                ...
                                <select  name="x12" class="form-control js-example-basic-single" required="required" oninvalid="this.setCustomValidity('Seleccione un País')" oninput="setCustomValidity('')">
                ...
                <div class="col s12 m12">
                    <div class="input-field col s12 m6">  
                        ...
                        <input type="text" class="form-control" id="google" name="google"  pattern="http(s)?://(.*\.)?youtube\.com\/[A-z 0-9 /_]+\/?" oninvalid="this.setCustomValidity('Ingrese un canal valido')" oninput="setCustomValidity('')">
                    </div>
                    <div class="input-field col s12 m6">
                        <i class="prefix blue-text valign-wrapper fa fa-instagram"></i>
                        <label>Instagram</label>
                        <input id="instagram" pattern="https?:\/\/(www\.)?instagram\.com\/[A-Za-z0-9_]+\/?" type="text" name="instagram" class="form-control"  oninvalid="this.setCustomValidity('Ingrese una cuenta de Instagram valido')" oninput="setCustomValidity('')">
                    </div>
                    <div class="input-field col s12 m6">
                        <i class="prefix blue-text valign-wrapper fa fa-facebook-square"></i>
                        <label>Facebook</label>
                        <input type="text" class="form-control" id="facebook" name="facebook"  pattern="http(s)?:\/\/(www\.)?(facebook|fb)\.com\" oninvalid="this.setCustomValidity('Ingrese una cuenta de Facebook valida')" oninput="setCustomValidity('')" >
                    </div>
                    <div class="col s12 m12">
