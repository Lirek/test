...
<html>
    ...
    <body>
        ...
        <center>
            <div class="alert alert-danger">Su usuario se encuentra inactivo debido a que decidio darse de baja de la plataforma, si tiene alguna duda o solicitud por favor enviar un correo a soporte@leipel.com</div>
        </center>
