    ...
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col s12 m12">
                ...
                <?php if(\Auth::guard('web_seller')->user()->id === $i_megazine->seller_id): ?>
                    ...
                    <div class="card-panel curva ">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                         <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('megazine_inde_update',$i_megazine->id)); ?>" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="col s12 m6">
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <?php if($i_megazine->status != 'Aprobado'): ?>
                                        <?php echo Form::text('title',$i_megazine->title,['class'=>'form-control','placeholder'=>'Titulo de la revista','required'=>'required','oninvalid'=>"this.setCustomValidity('Seleccione un título')",'oninput'=>"setCustomValidity('')"]); ?>

                                        <div id="mensajeTitulo"></div>
                                        <br>
                                    <?php else: ?>
                                        <?php echo Form::text('title',$i_megazine->title,['class'=>'form-control','placeholder'=>'Titulo de la revista',' readonly']); ?>
                                ...
                                <i class="material-icons prefix blue-text valign-wrapper">local_play</i>
                                    ...
                                    <?php if($i_megazine->status != 'Aprobado'): ?>
                                        <?php echo Form::number('cost',$i_megazine->cost,['class'=>'form-control', 'required'=>'required', 'oninvalid'=>"this.setCustomValidity('Escriba un costo en tickets')", 'oninput'=>"setCustomValidity('')", 'id'=>'precio', 'min'=>'0', 'max'=>'999']); ?>

                                        <div id="mensajePrecio"></div>
                                    <?php else: ?>
                                        <?php echo Form::number('cost',$i_megazine->cost,['class'=>'form-control','placeholder'=>'Costo en tickets', 'required'=>'required', 'oninvalid'=>"this.setCustomValidity('Escriba un costo en tickets')", 'oninput'=>"setCustomValidity('')", 'id'=>'precio', 'min'=>'0','readonly']); ?>
                                ...
                                <div class="input-field col s12">
                                    <div class="input-field col s12">
                                        ...
                                        <?php if($i_megazine->status != 'Aprobado'): ?>
                                            <?php echo Form::select('rating_id',$rating,$i_megazine->rating_id,['class'=>'form-control','id'=>'exampleInputFile','required'=>'required','oninvalid'=>"this.setCustomValidity('Seleccione una categoría')",'oninput'=>"setCustomValidity('')"]); ?>

                                        <?php else: ?>
                                            <?php echo Form::select('rating_id',$rating,$i_megazine->rating_id,['class'=>'form-control','id'=>'exampleInputFile','required'=>'required','oninvalid'=>"this.setCustomValidity('Seleccione una categoría')",'oninput'=>"setCustomValidity('')",'disabled'=>true ]); ?>
                                    ...
                                    <div class="col m6 s12">
                                        ...
                                        <div class="file-field input-field">
                                            ...
                                            <div class="btn blue">
                                                ...
                                                <?php echo Form::file('megazines_file',['class'=>'form-control','accept'=>'.pdf','control-label','placeholder'=>'cargar la revista','oninvalid'=>"this.setCustomValidity('Seleccione documento de la revista')",'oninput'=>"setCustomValidity('')",'id'=>'revista']); ?>
                            ...
                            <div class="col s12 m6">
                                <div class="input-field col s12">
                                    ...
                                    <?php echo Form::textarea('descripcion',$i_megazine->descripcion,['class'=>'form-control materialize-textarea','rows'=>'3','cols'=>'2','placeholder'=>'Sinopsis de la revista','required'=>'required','oninvalid'=>"this.setCustomValidity('Escriba una sinopsis de la revista')",'oninput'=>"setCustomValidity('')",'id'=>'sinopsis']); ?>
                            ...
                            <div class="col m6 s6">
                                <div align="">
                                    <a href="<?php echo e(url('/my_megazine',Auth::guard('web_seller')->user()->id)); ?>" class="btn btn-danger curvaBoton red">Atrás</a>
                                </div>
                            </div>
                            <div class="col m6 s6">
                                <div align="">
                                    <?php echo Form::submit('Editar revista', ['class' => 'btn btn-primary curvaBoton green','id'=>'guardarCambios']); ?>
