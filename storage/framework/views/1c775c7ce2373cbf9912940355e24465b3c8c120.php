...
<table class="wrapper" width="100%" cellpadding="0" cellspacing="0">
 <tr>
 	<td align="center">
 		<img src="<?php echo e($message->embed(public_path().'\sistem_images\content_denial.png')); ?>" width="100%" height="100%">
 	</td>
 </tr>

 <tr>
 	<td align="center">
		<h1>Su contenido <?php echo e($name); ?> ha sido DENEGADO por el siguiente motivo:</h1>
	</td>
 </tr>
