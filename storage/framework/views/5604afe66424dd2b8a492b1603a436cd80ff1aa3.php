 <div id="Modal" class="modal">
    <div class="modal-content center blue-text">
        <div class=" blue"><br>
            <h4 class="center white-text" ><i class="small material-icons"></i>Modifique el estatus de la saga</h4>
            <br>
        </div>
        <br>
        <div class="col s12">
 ...
 <div id="myModal" class="modal">
    <div class="modal-content center blue-text">
        <div class=" blue"><br>
            <h4 class="center white-text" ><i class="small material-icons"></i>Modifique el estatus del libro</h4>
            <br>
        </div>
        <br>
        <div class="col s12">
