                                 ...
                                 <li class="collection-item avatar">
                                     <div class="row">
                                         ...
                                         <div class="col s8 left">
                                            <h4 class="grey-text"><?php echo e(Auth::user()->codigo_ref); ?></h4>
                                         </div>
                                     </div>
                                 </li>
                                 <li class="collection-item avatar">
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col s7 left"><br>
                                          ...
                                          <div class="fb-share-button" 
                                            data-href="<?php echo e(url('/').'/register/'.Auth::user()->codigo_ref); ?>" 
                         ...
                         <div class="col s12 m4">
                             <div class="card ">
                                 <div class="card-content curva">
                                     ...
                                     <div class="col s12 m12">
                                     <h5>Mi código QR:</h5>
                                         <?php echo QrCode::size(250)->generate( url('/').'/register/'.Auth::user()->codigo_ref);; ?>

                                         <a href="data:image/png;base64,<?php echo base64_encode (QrCode::format('png')->size(300)->generate( url('/').'/register/'.Auth::user()->codigo_ref)); ?>" download="MiQr" class="waves-effect green curvaBoton waves-light btn-small"><i class="material-icons right">cloud_download</i>Descargar</a>
                                     </div>
                                 </div>
                                 </div>
                             </div>
