                ...
                <div class="row">
                    <div class="col s12 m12 center">
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="input-field col m6  <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            ...
                            <div class=" input-field col m6  <?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                <i class="material-icons prefix blue-text">email</i>
                                 <label for="email" id="labeEmail">Correo electrónico del contacto</label>
                                <input id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" required="required">
                            ...
                            <div class="input-field col m6  <?php echo e($errors->has('tlf') ? ' has-error' : ''); ?>">
                                <i class="material-icons prefix blue-text">phone</i>
                                <label for="tlf" class="" id="labeTlf">Teléfono del contacto</label>
                                <input id="tlf" type="text" class="form-control" name="tlf" value="<?php echo e(old('tlf')); ?>" required="required">
                            ...
                            <div class="input-field col m6  <?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
                                ...
                                <input id="address" type="text" class="form-control" name="address" value="<?php echo e(old('address')); ?>" required="required">
                            ...
                            <div class="input-field col m6  <?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
