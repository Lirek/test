                    ...
                    <div id="profile-card" class="card">
                        ...
                        <div class="card-content">
                            <div id="image-preview" class="img circle left activator btn-move-up waves-effect waves-light darken-2">
                                <?php echo Form::file('logo',['class'=>'form-control-file', 'control-label', 'id'=>'avatarInput', 'accept'=>'image/*']); ?>

                                <?php echo Form::hidden('img_posterOld',$seller->logo); ?>

                                <div id="list">
                                    <?php if($seller->logo != NULL): ?>
                                        <img width="70" height="70" name='perf' src="<?php echo e(asset($seller->logo)); ?>" id="avatarImage">
                                    <?php else: ?>
                                        <img width="70" height="70" name='sinPerf' src="<?php echo e(asset('plugins/img/sinPerfil.png')); ?>" id="avatarImage">
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col s12">
                                    <div class="col s3">
                                        ...
                                        <?php echo e(Auth::guard('web_seller')->user()->name); ?></h5>
                                    </div>
                                     <div class="col s3">
                                        <i class=" mdi-action-perm-identity cyan-text text-darken-2"></i>
                                        <h5><?php echo e($content_for_aprove); ?></h5>
                                        <label>contenido en revisión</label>
                                    </div>
                                    <div class="col s3">
                                        <i class=" mdi-action-perm-identity cyan-text text-darken-2"></i>
                                        <h5><?php echo e($total_content); ?></h5>
                                        <label>contenido total</label>
                                    </div>
                                    <div class="col s3">
                                        <i class=" mdi-action-perm-identity cyan-text text-darken-2"></i><h5><?php echo e($total_aproved); ?></h5>
                    ...
                    <div class="card-image waves-block" style="height: 65px; padding-top: 9px">
                        ...
                        <h4 class="titelgeneral"> Datos a editar</h4>
                            ...
                            <div class="input-field col s12">
                                ...
                                <?php if($seller->estatus == 'Aprobado'): ?>
                                    <?php echo Form::text('ruc_s',$seller->ruc_s,['class'=>'form-control','id'=>'ruc','readonly']); ?>
                            ...
                            <div class="file-field input-field col s12">
                                ...
                                <div class="btn blue">
                                    ...
                                    <?php echo Form::file('adj_ruc',['class'=>'form-control','accept'=>'.img*, .pdf','id'=>'img_doc','control-label','placeholder'=>'cargar libro','oninvalid'=>"this.setCustomValidity('Seleccione imagen del RUC')"]); ?>
                            ...
                            <?php endif; ?>
                                <div  class="col m12">
                                    <?php if($seller->adj_ruc && pathinfo($seller->adj_ruc, PATHINFO_EXTENSION) != 'pdf'): ?>
                                    ...
                                    <?php elseif(pathinfo($seller->adj_ruc, PATHINFO_EXTENSION) == 'pdf'): ?>
                                        <object id="pdfruc" data="<?php echo e(asset($seller->adj_ruc)); ?>" class="text-center"  type="application/pdf" align="center" width="380" height="180"></object>
                                        <br>
                            ...
                            <div class="input-field col s12" style="display: none;">
                                <i class="material-icons prefix blue-text">security</i>
                                 ...
                                 <label  for="account_status">Estado de cuenta</label>
                                  ...
                                  <div class="input-field col s12">
                                      <?php echo Form::submit('Actualizar', ['class' => 'btn btn-primary active curvaBoton green','id'=>'Editar']); ?>
                ...
                <div class="card-content">
                    ...
                    <a class="modal-trigger" href="#modal1">CAMBIAR CONTRASEÑA</a></blockquote>
                        <div id="modal1" class="modal">
                            ...
                            <?php echo Form::open(['url'=>['ChangePasswordSeller',$seller],'method'=>'POST','files'=>true,'class'=>'form-horizontal','id'=>'changepassword']); ?>
