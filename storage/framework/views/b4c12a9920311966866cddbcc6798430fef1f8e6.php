                                    ...
                                    <?php if($modulos!=false): ?>
                                        <?php $__currentLoopData = $modulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($mod->name == 'Radios'): ?>
                                                <li>
                                                    <a href="#"  class="contentype-adjust"><b><img class="responsive-img img-contentype" src="<?php echo e(asset('sistem_images/type_contents/radio.svg')); ?>"> </b></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if($mod->name == 'TV'): ?>
                                                <li>
                                                    <a href="#"  class="contentype-adjust"><b><img class="responsive-img img-contentype" src="<?php echo e(asset('sistem_images/type_contents/tv.svg')); ?>"> </b></a>
                                                </li>
                                            <?php endif; ?>
