                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <?php echo Form::select('status_series',['1'=>'En Emisión', '2'=>'Finalizado'],null,['class'=>'form-control select-author', 'required'=>'required', 'oninvalid'=>"this.setCustomValidity('Seleccione una opción')",'oninput'=>"setCustomValidity('')", 'id'=>'exampleInputFile']); ?>
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <?php echo Form::number('cost',null,['class'=>'form-control', 'required'=>'required', 'id'=>'precio', 'oninvalid'=>"this.setCustomValidity('Escriba un Precio')", 'oninput'=>"setCustomValidity('')", 'min'=>'0', 'onkeypress' => 'return controltagNum(event)', 'oninput'=>"maxLengthCheck(this)"]); ?>
                        ...
                        <div class="col s12 m12">
                            <div class="input-field col s12 m6">
                                ...
                                <?php echo Form::textarea('story',null,['class'=>'materialize-textarea','required'=>'required','oninvalid'=>"this.setCustomValidity('Escriba una historia de la serie')", 'oninput'=>"setCustomValidity('')",'id'=>'historia']); ?>
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <?php echo Form::number('release_year',@date('Y'),['class'=>'form-control', 'id'=>'fechaLanzamiento', 'min'=>'0', 'max'=>"@date('Y')", 'oninput'=>"setCustomValidity('')", 'oninvalid'=>"this.setCustomValidity('Seleccione el año de lanzamiento')"]); ?>
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <?php echo Form::url('trailer',null,['class'=>'form-control', 'required'=>'required', 'oninvalid'=>"this.setCustomValidity('Ingrese el link del trailer de la serie')", 'oninput'=>"setCustomValidity('')", 'id'=>'link']); ?>
                    ...
                    <label class="control-label"> ¿Pertenece a una saga? </label>
                        ...
                        <div class="" style="display:none" id="if_si">
                            <div class="input-field col s12">
                                ...
                                <?php echo Form::select('saga_id',$saga,null,['class'=>'form-control select-saga','placeholder'=>'Selecione una saga','id'=>'sagas', 'oninvalid'=>"this.setCustomValidity('Ingrese el nombre de la saga')", 'oninput'=>"setCustomValidity('')"]); ?>
                    ...
                    <div class="row">
                        <div class="col s12">
                            ...
                            <div class="input-field col s12">
                                ...
                                <?php echo Form::text('tags_name',null,['class'=>'form-control', 'id'=>'new_tag','required'=>'required','oninvalid'=>"this.setCustomValidity('Ingrese el nuevo género')",'oninput'=>"setCustomValidity('')"]); ?>
