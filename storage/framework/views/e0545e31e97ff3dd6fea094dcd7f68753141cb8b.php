                            ...
                            <div id="image-preview" class="img circle left activator btn-move-up waves-effect waves-light darken-2">
                                ...
                                <div id="list">
                                    <?php if($seller->logo != 'NULL'): ?>
                                        <img width="70" height="70" name='perf' src="<?php echo e(asset($seller->logo)); ?>" id="img_perf">
                                    <?php else: ?>
                                        <img width="70" height="70" name='sinPerf' src="<?php echo e(asset('plugins/img/sinPerfil.png')); ?>" id="img_perf">
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="card-image waves-block" style="height: 65px; padding-top: 9px">
                        <span class="collection-header center">Datos a editar</span>
                            ...
                            <div class="input-field col s12 ">
                                ...
                                <?php echo Form::text('name',$seller->name,['class'=>'form-control', 'required'=>'required','onkeypress' => 'return controltagLet(event)', 'pattern' => '[A-Za-zñÑáéíóúÁÉÍÓÚ\s]+','id'=>'nombre','required'=>'required']); ?>
                            ...
                            <div class="file-field input-field col s12">
                                ...
                                <div class="btn blue">
                                    ...
                                    <?php echo Form::file('adj_ruc',['class'=>'form-control','accept'=>'.img*','id'=>'img_doc','control-label','placeholder'=>'cargar libro','oninvalid'=>"this.setCustomValidity('Seleccione imagen del RUC')"]); ?>
