...
<div class="row">
    <div class="col s12 m8 offset-m2">
        ...
        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/seller_password/reset')); ?>" id="change">
            ...
            <div class="row">
                <div class="input-field col s12  <?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                    ...
                    <input id="verEmail" type="email" class="form-control" name="email" value="<?php echo e(old('email', $email)); ?>" readonly="true" autofocus >
