                    ...
                    <div class="col s12 m3">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="col m12">
                                    <p class="" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; width: auto;"><?php echo e($b->name_alb); ?></p>
                                </div>
                                <div class="col m12 ">
                ...
                <div class="row ">
                    ...
                    <div class="col s12 m3">
                        <div class="card" style="height: 450px">
                            <div class="card-image">
                                <a href="<?php echo e(url('/show_song/'.$song->id)); ?>">
                                    <?php if($song->cover == NULL): ?>  
                                        <img src="<?php echo e(asset($song->autors->photo)); ?>" width="100%" height="300px">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset($song->cover)); ?>" width="100%" height="300px">
                                    <?php endif; ?> 
                                </a>
                              <!-- <span class="card-title">Card Title</span> -->
                            ...
                            <div class="card-content">
                                <div class="col m12">
                                    <p class="" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; width: auto;"><?php echo e($song->song_name); ?></p>
                                </div>
                                <div class="col m12 ">
