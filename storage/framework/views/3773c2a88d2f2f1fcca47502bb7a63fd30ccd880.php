...
// funcion para listas las publicaciones
        function listadoPu(status) {
            ...
            var ruta = "<?php echo e(url('PubChainDataTable')); ?>"+"/"+parametros;
        ...
        function listado(status) {
            $("#Revistas").empty();
            var parametros = status;
            var ruta = "<?php echo e(url('MegazineDataTable')); ?>"+"/"+parametros;
            var gif = "<?php echo e(asset('/sistem_images/loading.gif')); ?>";
            swal({
                title: "Procesando la información",
                text: "Espere mientras se procesa la información.",
                ...
                success: function (data) {
                    ...
                    $.each(data,function(i,info) {
                        ...
                        if (info.status=="En Revision") {
                            var opcion = "<a class='btn curvaBoton' target='_blank' href='<?php echo asset('"+info.megazine_file+"'); ?>' href='#file' id='file_b'>Ver Revista</a> <button class='btn modal-trigger curvaBoton green' value='"+info.id+"' value2='En Revision' href='#myModal' id='status'>"+info.status+"</button>"
