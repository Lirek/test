                        ...
                        <div class="white-header" style="padding: 45px">
                          ...
                          <div class="row">
                            <div class="col-sm-10 col-xs-10 col-md-10">
                              <h3 style="margin-left: 20%">Obtenga <?php echo e($ticket->amount); ?> Tickets</h3>
                              <h3 style="margin-left: 20%"><b>Costo:</b> $<?php echo e($ticket->cost); ?> (Incluido IVA)</h3>
                              <div class="paragraph">
                                <p class="center " id="mensaje"></p>
                               
                                        <p style="margin-left: 10%; margin-bottom: 2%;"><a href="#" class="buttonCenter" data-toggle="modal" data-target="#myModal-<?php echo e($ticket->id); ?>"><h4>Adquirir</h4></a></p>
                        ...
                        <!-- Modal content-->
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" method="POST" action="<?php echo e(url('BuyPlan')); ?>" enctype="multipart/form-data"><?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5 align="center"><b>Cantidad de tickets:</b> <?php echo e($ticket->amount); ?></h5>
                                    ...
                                    <div class="form-group<?php echo e($errors->has('codigo') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                                            <input type="number" min="1" max="20" value="1" class="form-control input-sm" name="Cantidad" id="Cantidad" value="<?php echo e(old('Cantidad')); ?>" onkeypress="return controltagNum(event)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="display:none;" id="deposito" align="center">
                                        <input id="voucher" type="file" accept=".jpg" class="form-control" name="voucher" value="<?php echo e(old('voucher')); ?>" required="required">
                                    </div>
                                    <div class="form-group">
