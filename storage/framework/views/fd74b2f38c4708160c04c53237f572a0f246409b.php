        ...
        <div class="modal-body">
         <p>Modifique el estatus de la Cadena de Publicacion</p>
             ...
             <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-2">
                <input type="radio" id="option-2" class="mdl-radio__button" onclick="javascript:yesnoCheck();" name="status_p" value="Denegado">
             ...
             <div class="radio-inline" style="display:none" id="if_no">
              <div class="mdl-textfield mdl-js-textfield">
               <textarea name="message_p" class="mdl-textfield__input" type="text" rows= "6" id="razon" ></textarea>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <p>Modifique el estatus de la Revista</p>
             ...
             <div class="radio-inline" style="display:none" id="if_no">
              <div class="mdl-textfield mdl-js-textfield">
               <textarea name="message" class="mdl-textfield__input" type="text" rows= "6" id="razon1" ></textarea>
               <label class="mdl-textfield__label" for="razon">Explique La Razon</label>
              </div>
             </div>
