                            ...
                            <div class="card">
                                <div class="card-image">
                                    <?php if($ci['type']=='Pelicula'): ?>
                                       <?php if($ci['adquirido']): ?>
                                       <a class="waves-effect waves-light " href="<?php echo e(url('ShowMyMovie/'.$ci['id'])); ?>">
                                       <img  src="<?php echo e(asset($ci['img_poster'])); ?>" id="img_cartelera_largo">
                                       </a>

                                        <a class="btn-floating btn-small halfway-fab waves-effect waves-light green" href="<?php echo e(url('ShowMyMovie/'.$ci['id'])); ?>">
                                    ...
                                    <?php else: ?>
                                        <?php if($ci['adquirido']): ?>
                                        <a class=" waves-effect waves-light " href="<?php echo e(url('ShowMySerie/'.$ci['id'].'/'.'Serie')); ?>">
                                         <img  src="<?php echo e(asset($ci['img_poster'])); ?>" id="img_cartelera_largo">
                                         </a>
                                        <a class="btn-floating btn-small halfway-fab waves-effect waves-light green" href="<?php echo e(url('ShowMySerie/'.$ci['id'].'/'.'Serie')); ?>">
                        ...
                        <?php $__currentLoopData = $musica; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card">
                                <div class="card-image">
                                    ...
                                    <?php else: ?>
                                        <?php if($m['adquirido']): ?>
                                        <a class="waves-effect waves-light " href="<?php echo e(url('MyMusic')); ?>">
                                        <img src="<?php echo e(asset($m['cover'])); ?>" id="img_cartelera_largo">
                                        </a>
                                        <a class="btn-floating btn-small halfway-fab waves-effect waves-light green" href="<?php echo e(url('MyMusic')); ?>">
