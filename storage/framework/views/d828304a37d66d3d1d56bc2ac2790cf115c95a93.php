        ...
        <header>
                        ...
                        <div class="nav-wrapper">
                            ...
                            <!-- Img Contenido superior -->
                                <ul class="right" >
                                    ...
                                    <li>
                                        <a href="<?php echo e(url('MusicContent')); ?>"  class="contentype-adjust"><b><img class="responsive-img   img-contentype" src="<?php echo e(asset('sistem_images/type_contents/musica.svg')); ?>"> </b></a>
                                    </li>
                ...
                <ul id="slide-out" class="sidenav sidenav-fixed">
                   ...
                   <li><div class="divider"></div></li>
                        ...
                        <ul class= "collapsible collapsible-accordion" >
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="<?php echo e(url('ShowMovies')); ?>" class="collapsible-header waves-effect waves-blue"><i class="small material-icons left" >movie</i>Cine</a></li>
                                        <li><a href="<?php echo e(url('MusicContent')); ?>"><i class="small material-icons left" >music_note</i>Música</a></li>
                                        <li><a href="<?php echo e(url('ReadingsBooks')); ?>" class="collapsible-header waves-effect waves-blue"><i class="small material-icons left" >book</i>Lectura</a></li>
                    ...
                    <li><a href="<?php echo e(url('Beneficios')); ?>/Aprobado" class="waves-effect waves-blue"><i class="small material-icons">flight_takeoff</i>Beneficios</a></li>

                    <li><a href="<?php echo e(url('SaleTickets')); ?>" class="waves-effect waves-blue"><i class="small material-icons">monetization_on</i>Tickets</a></li>
