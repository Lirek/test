  ...
  <div class="modal" id="NewTv">
    <div class="modal-content">
      ...
      <div style="margin-top: -15px">
        <form method="POST" id="NewRadioForm" action="<?php echo e(url('NewBackendTv')); ?>" enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>
  ...
  <div class="modal" id="updateTv">
    <div class="modal-content">
      ...
      <div style="margin-top: -15px">
        <form method="POST" id="UpdateTvForm" action="<?php echo e(url('UpdateBackendTv')); ?>" enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>
