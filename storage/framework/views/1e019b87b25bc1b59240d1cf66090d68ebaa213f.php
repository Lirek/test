...
<div class="row">
    <div class="col s12 m12">
        ...
        <div class="card-panel curva">
            <h4 class="titelgeneral"><i class="mdi mdi-book-open-page-variant"></i>  "<?php echo e($megazine->title); ?>"</h4>
            <br>
            <div class="row">
                <div class="col s12 m4">
                    <img src="<?php echo e(asset($megazine->cover)); ?>" width="100%" height="300" style="bor<der-radius: 10px" id="panel">
                    <br><br>
                    <a href="#modal-default" class="btn curvaBoton waves-effect waves-light green  modal-trigger" >Leer libro</a>
                        <a href="<?php echo e(url('/my_megazine',Auth::guard('web_seller')->user()->id)); ?>" class="btn curvaBoton waves-effect waves-light red">Atrás</a>
                </div>
                    ...
                    <ul class="collection z-depth-1" >
                        ...
                        <li class="collection-item" style="padding: 10px ">
                            <div class="row">
                                ...
                                <div class="col s12 m7">
                                    <?php echo e($megazine->rating->r_name); ?>
                        ...
                        <li class="collection-item" style="padding: 10px ">
                            <div class="row">
                                ...
                                <div class="col s12 m7">
                                    <?php echo e($megazine->cost); ?> Tickets
                                </div>
                            </div>
                        </li>
                        <li class="collection-item" style="padding: 10px ">
                    ...
                    <div class="card blue accent-2">
                        <div class="card-content white-text center-align">
                            <p class="card-title">
                                ...
                                <?php echo e($megazine->transaction->count()); ?>
...
<div id="modal-default" class="modal" >
    <div class="modal-content modal-lg">
        <div class=" blue"><br>
            <h4 class="center white-text" ><i class="small material-icons">book</i>"<?php echo e($megazine->title); ?>"</h4>
            <br>
        </div>
        <br>
        <div class="pdf">
            ...
            <object data="<?php echo e(asset($megazine->megazine_file)); ?>" class="text-center" style="width:100%;height:800px;" type="application/pdf"></object>
        </div>  
...
<!--Sinopsis-->
  <div id="modal1" class="modal bottom-sheet">
    <div class="modal-content">
      <h6><b>Sinopsis:</b></h6>
      <p><?php echo e($megazine->descripcion); ?></p>
    </div>
    <div class="modal-footer">
