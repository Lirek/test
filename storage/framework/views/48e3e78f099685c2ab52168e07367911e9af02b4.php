                        ...
                        <p class="centered">
                            ...
                            <a href="<?php echo e(url('/seller_home')); ?>">
                                <?php if(Auth::guard('web_seller')->user()->logo): ?>
                                    <img src="<?php echo e(asset(Auth::guard('web_seller')->user()->logo)); ?>" class="img-circle"  width="80" height="80">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('sistem_images/DefaultUser.png')); ?>" class="img-circle" width="80" height="80">
                                <?php endif; ?>
                            </a>
                        </p>
