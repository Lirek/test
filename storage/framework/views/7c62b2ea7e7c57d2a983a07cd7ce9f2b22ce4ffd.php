...
<div class="row">
    <div class="col s12 m12">
        ...
        <?php if($collection->count() != 0 ): ?>
            <div class="row">
                <?php $__currentLoopData = $collection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(Auth::guard('web_seller')->user()->id === $b->seller_id): ?>
                <div class="col s12 m3">
                  <div class="card">
                    <div class="card-image">
                        <a href="<?php echo e(url('/show_pub/'.$b->id)); ?>">
                      <img src="<?php echo e(asset($b->img_saga)); ?>" width="100%" height="300px">
                      </a>
                      <!-- <span class="card-title">Card Title</span> -->
                        <a class="btn-floating halfway-fab waves-effect waves-light blue" href="<?php echo e(url('/type_update/'.$b->id)); ?>"><i class="material-icons">create</i></a>
                    </div>
                    <div class="card-content">
                        <div class="col m12">
                            <p class=""><?php echo e($b->sag_name); ?></p>
                        </div>
                        <div class="col m12 ">
                            <small><b>Estatus:</b> <?php echo e($b->status); ?></small>
                        </div>  
                            <small><b>Genero:</b> <?php echo e($b->rating->r_name); ?></small>
            ...
            <a href="<?php echo e(url('/type')); ?>" class="btn curvaBoton waves-effect waves-light green">   
        ...
        <?php if($single->count() != 0 ): ?>
            <div class="row">
                <?php $__currentLoopData = $single; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(Auth::guard('web_seller')->user()->id === $b->seller_id): ?>
                <div class="col s12 m3">
                  <div class="card">
                    <div class="card-image">
