...
<?php $__env->startSection('main'); ?>
    ...
    <?php echo $__env->make('promoter.modals.TvViewModal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        function tvs(status) {
            ...
            $.ajax({
                url: "<?php echo url('DataTableTv'); ?>/"+status,
                type: "GET",
                dataType: "json",
        ...
        function tvBackend(status) {
            ...
            $.ajax({
                url: "<?php echo url('BackendTV'); ?>/"+status,
                type: "GET",
                dataType: "json",
                success: function (data) {
                    swal.close();
        ...
        $(document).on('click', '#status', function() {
            ...
            $("#formStatus").on('submit', function(e) {
                ...
                var url = "<?php echo e(url('TvStatus/')); ?>/"+x;
        ...
        $(document).on('click', '#editTv', function() {
            ...
            $.ajax({
                url : "<?php echo e(url('BackendTv/')); ?>/"+tv,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    swal.close();
        ...
        $(document).on('click', '#deleteTv', function() {
            ...
            swal({
                ...
                if (confir) {
                    ...
                    var url = "<?php echo e(url('DeleteBackendTv')); ?>/"+x;
                    $.ajax({
                        url: url,
                        type:'get',
                        dataType:"json",
