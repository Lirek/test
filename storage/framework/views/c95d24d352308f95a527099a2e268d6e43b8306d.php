                            ...
                            <div class="card">
                                    ...
                                    <a href="<?php echo e(url('ShowMyReadBook/'.$Book->id)); ?>">
                                        ...
                                        <?php if($Book->cover): ?>
                                            ...
                                            <img src="images/bookcover/<?php echo e($Book->cover); ?>" width="140%" height="220" style="">
                                ...
                                <div class="card-content">
                                    ...
                                    <span> <a id='autor' href="ProfileBookAuthor/<?php echo e($Book->id); ?>"><?php echo e($Book->author->full_name); ?></a></span>
                                </div>
                            </div>
                        </div>
