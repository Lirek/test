                ...
                <!-- PROFILE 01 PANEL -->
                    <div class="col s6 m3 ">
                        <div class="card">
                            ...
                            <a href="<?php echo e(url('ShowMyReadMegazine/'.$Megazine->id)); ?>">
                            <?php if($Megazine->cover): ?>
                                    <div class="card-image">
                                        <img src="<?php echo e(asset($Megazine->cover)); ?>" width="100%" height="300" style="">
                                        <a href="<?php echo e(url('ShowMyReadMegazine/'.$Megazine->id)); ?>" class="btn-floating halfway-fab waves-effect waves-light blue btn tooltipped " data-position="bottom" data-tooltip="Detalles"><i class="mdi mdi-book-open-page-variant"></i></a>

                                    </div>
                                <?php else: ?>
                                    <div class="card-image grey lighten-2">
                                        <img src="#" width="100%" height="300"  style="">
                                        <a href="<?php echo e(url('ShowMyReadMegazine/'.$Megazine->id)); ?>" class="btn-floating halfway-fab waves-effect waves-light blue lighten-2 btn tooltipped" data-position="top" data-tooltip="Detalles"><i class="mdi mdi-book-open-page-variant"></i></a>
                                    </div>

                                <?php endif; ?>
                            </a>
                            <div class="card-content">
                              <span class="card-title title"> <b><?php echo e($Megazine->title); ?></b> </span>
                                <!--
                               <span class="card-title blue-text title" style=" font-size: 16px;"> <b></b> </span>-->
