                          ...
                          <div class="col s12 m12 l8">
                              <ul id="projects-collection" class="collection">
                                    ...
                                    <div class="input-field col s12 ">
                                        <i class="material-icons prefix blue-text">face</i>
                                        <?php echo Form::text('name',$user->name,['class'=>'form-control', 'onkeypress' => 'return controltagLet(event)', 'pattern' => '[A-Za-zñÑáéíóúÁÉÍÓÚ\s]+','id'=>'nombre']); ?>
                                    ...
                                    <div class="input-field col s12">
                                        ...
                                        <?php echo Form::text('email',$user->email,['class'=>'form-control','readonly','id'=>'email']); ?>
                            ...
                            <div class="col s12 m6 l4">
                                <div id="profile-card" class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <?php if($mipatro != null): ?>
                                            <?php echo e($mipatro->name); ?>

                                            <br>
                                            <?php echo e($mipatro->email); ?>

                                            <br>
                                            <?php echo e($mipatro->phone); ?>
