                                                ...
                                                <div class="modal-content">
                                                  <div class="card-content"> Desea cambiar su contraseña?<br><br> 
                                                     <div class="input-field col s12">
                                                       ...
                                                       <?php echo Form::open(['url'=>['ChangePassword',$user],'method'=>'POST', 'files'=>true,'class'=>'form-horizontal','id'=>'edit']); ?>

                                                         <?php echo Form::text('password',$user->password,['class'=>'form-control']); ?>   
                                                     </div>
                                                     
                                                     <a href="<?php echo e(url('ChangePassword', $user->id)); ?>" class="btn btn-primary green curvaBoton active modal-close">Actualizar</a>
