    ...
    <div class="col-sm-7">
     ...
     <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <input type="text" value="<?php echo e($song->song_name); ?>" name="song_n" id="song_n" placeholder="Nombre de la Cancion" class="form-control" oninvalid="this.setCustomValidity('Ingrese un Nombre Valido')"
                          oninput="setCustomValidity('')" required>
          
          <input type="number" name="cost" value="<?php echo e($song->cost); ?>" id="name1" class="form-control" placeholder="Costo en Tickets" required pattern="{1-3}" oninvalid="this.setCustomValidity('Ingrese un Costo en Tickets No Mayor a 100')" oninput="setCustomValidity('')">
                        ...
                        <label for="tags"> 
                         ...
                         <select name="tags[]" multiple="true"  class="form-control js-example-basic-multiple">
                             ...
                             <?php if($s->id == $genders->id): ?> selected
                             <?php endif; ?>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>>
                        ...
                        <select name="artist" class="form-control js-example-basic-single">
                        <option value="<?php echo e($artist->id); ?>" <?php if($song->autors_id==$artist->id): ?> selected <?php endif; ?>><?php echo e($artist->name); ?></option>                         </select>
