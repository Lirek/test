...
<div class="row">
    <div class="col s12 m12">
        ...
        <div class="card-panel curva">
            <h3 class="center">
                Modificar <?php echo e($a->type_authors); ?>
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m6">
                    ...
                    <input id="art_name" type="text" value="<?php echo e($a->name); ?>" class="form-control" name="art_name" required="required" rows="3" cols="2" oninvalid="this.setCustomValidity('Inserte un nombre de artista o agrupacion valido')" oninput="setCustomValidity('')">   
                    <br>
                </div>
                <div class="input-field col s12 m6">
                    ...
                    <textarea class="materialize-textarea" name="dsc" placeholder="Descripción" id="descripcion" oninvalid="this.setCustomValidity('Inserte una descripción valida')" oninput="setCustomValidity('')"required="required"><?php echo e($a->descripcion); ?></textarea>
                    <br>
                </div>
                <div class="input-field col s12 m6">
