    ...
    <div class="row">
        <div class="col s12">
            ...
            <div class="card-panel curva">
                <h4 class="titelgeneral"><i class="material-icons small">radio</i> <?php echo e($tv->name_r); ?> </h4>
                <div class="row">
                    <div class="col s12 m4">
                        <img src="<?php echo e(asset($tv->logo)); ?>" width="100%" height="300" style="bor<der-radius: 10px" id="panel" class='materialboxed'>
                        <br>
                        <a href="<?php echo e(url('/tvs')); ?>" class="btn curvaBoton waves-effect waves-light red">Atrás</a>
                        <a href="<?php echo e(route('tvs.edit', $tv->id)); ?>" class="btn curvaBoton waves-effect waves-light green">Modificar</a>
                    </div>
