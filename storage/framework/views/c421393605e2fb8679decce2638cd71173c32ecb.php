...
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.18.1/moment.min.js"></script>
	...
	function listado(status) {
			...
			var ruta = "<?php echo e(url('AlbumDataTable')); ?>"+"/"+parametros;
  ...
  // Modificar el estatus de un album
  $(document).on('click','#status', function() {
    ...
    $("#FormStatus").on('submit', function(e){
      ...
      var url = "<?php echo e(url('/admin_album')); ?>/"+x;
      console.log(url);
      e.preventDefault(); 
      console.log(s);
      $.ajax({
  ...
  // Listar las canciones
		$(document).on('click', '#Canciones', function(e) {
			...
			var url = "<?php echo e(url('/admin_songs')); ?>/"+id;
			console.log(url);
			$("#cancion").empty();
				e.preventDefault();
				$.ajax({
