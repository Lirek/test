                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12" style=" margin-bottom: 5%">
                                    <input type="number" min="1" max="<?php echo e(Auth::guard('web_seller')->user()->credito); ?>" value="1" class="form-control input-xs" name="Cantidad" id="monto" value="<?php echo e(old('Cantidad')); ?>" onkeypress="return controltagNum(event)">
