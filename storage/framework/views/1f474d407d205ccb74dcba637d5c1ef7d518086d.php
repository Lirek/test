                        ...
                        <?php $__currentLoopData = $cine; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ci): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card">
                                <div class="card-image">
                                    <img img src="<?php echo e(asset($ci['img_poster'])); ?>" id="img_cartelera_largo">
                                    <?php if($ci['type']=='Pelicula'): ?>
                                        <a class="btn-floating btn-small halfway-fab waves-effect waves-light blue" href="<?php echo e(url('ShowMovies/'.$ci['id'])); ?>">
                                            <i class="small material-icons">movie</i>
                                        </a>
                                    <?php else: ?>
                                        <a class="btn-floating btn-small halfway-fab waves-effect waves-light blue" href="<?php echo e(url('SerieList/'.$ci['id'])); ?>">
                ...
                <div class="col s12">
                    <div class="owl-carousel owl-theme">
                        <?php $__currentLoopData = $radio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card">
                                <div class="card-image">
                                    <a href="<?php echo e(url('ListenRadio/'.$r['id'])); ?>">
