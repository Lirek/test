...
<html>
	<body>
		<table class="wrapper" width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td align="center">
					<h1>Su PAGO ha sido ENTREGADO.</h1>
				</td>
			</tr>
			...
			<tr>
				<td>
					<p style="font-size: 14px;" align="justify">
						Hola, nos complecemos en informarle que su PAGO ha sido ENTREGADO, gracias por preferirnos como su plataforma de red social.
					</p>
				</td>
			</tr>
