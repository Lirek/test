            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data,function(i,info) {
                        ...
                        if (info.img_saga!=0 ) {
                            var portada = 
                            "<img class='materialboxed' width='150' height='120' src='<?php echo asset('/images/sagas/"+info.img_saga+"'); ?>'";
                        } else {
