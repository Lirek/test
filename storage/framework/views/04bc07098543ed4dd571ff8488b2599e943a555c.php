                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body ">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?php echo Form::text('original_title',null,['class'=>'form-control col-xs-2','placeholder'=>'Titulo original de la película','required'=>'required','id'=>'titulOriginal','oninvalid'=>"this.setCustomValidity('Seleccione el título original')",'oninput'=>"setCustomValidity('')"]); ?>
                            ...
                            <?php echo Form::select('rating_id',$ratin,null,['class'=>'form-control select-author','placeholder'=>'Selecione una categoría','required'=>'required','oninvalid'=>"this.setCustomValidity('Seleccione una categoría')",'oninput'=>"setCustomValidity('')"]); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?php echo Form::file('duration',['class'=>'form-control','accept'=>'.mp4','control-label','placeholder'=>'Cargar película','id'=>'pelicula','required'=>'required','oninvalid'=>"this.setCustomValidity('Seleccione la película')",'oninput'=>"setCustomValidity('')"]); ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label for="exampleInputFile" class="control-label">Categoría</label>
                                <?php echo Form::select('rating_id',$ratin,null,['class'=>'form-control select-author','placeholder'=>'Selecione una categoría','id'=>'exampleInputFile','required'=>'required']); ?>
                                ...
                                <?php echo Form::select('type_saga',['2'=>'Peliculas'],null,
                        ...
                        <div align="center">
                            <?php echo Form::submit('Guardar saga', ['class' => 'btn btn-primary','id'=>'registrarSaga']); ?>
