...
<nav class="default_color" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo"><img class= "img"src="https://leipel.com/plugins/img/Logo-Leipel.png" width="120px;" height="50px;" title="Logo de Leipel"></a>
        <ul class="right hide-on-med-and-down">
            ...
            <?php elseif(Auth::guard('bidder')->user()): ?>
                <?php if(Auth::guard('bidder')->user()->logo): ?>
                    <li>
                        <a href="<?php echo e(url('/bidder_home')); ?>" data-position="bottom"  class="tooltipped" data-tooltip="Ingresar">
                            <img src="<?php echo e(asset(Auth::guard('bidder')->user()->logo)); ?>" class="img circle" width="40" height="40">
                        </a>
                    </li>
                <?php else: ?>
                    <li>
                        <a href="<?php echo e(url('/home')); ?>" data-position="bottom"  class="tooltipped" data-tooltip="Ingresar">
                            <img src="<?php echo e(asset('sistem_images/DefaultUser.png')); ?>" class="img circle" width="40" height="40">
                        </a>
                    </li>
                <?php endif; ?>
        ...
        <ul id="nav-mobile" class="sidenav">
            ...
            <?php elseif(Auth::guard('bidder')->user()): ?>
                <?php if(Auth::guard('bidder')->user()->logo): ?>
                    <li>
                        <a href="<?php echo e(url('/bidder_home')); ?>" data-position="right"  class="tooltipped" data-tooltip="Ingresar">
                            <img src="<?php echo e(asset(Auth::guard('bidder')->user()->logo)); ?>" class="img circle" width="40" height="40">
                        </a>
                    </li>
                <?php else: ?>
                    ...
                    <div class="col s12 m12">
                        <div class="card">
                            <div class="card-image ">
                                ...
                                <?php else: ?>
                                   <a onclick="masInfo('cine')">
                                    <img src="<?php echo e(asset($m['img_poster'])); ?>" width="100%" height="300px">
                                   </a>
                                <?php endif; ?>
                            </div>
                        </div>
...
<div id="modal1" class="modal">
    <div class="modal-content center blue-text">
        ...
        <div id="aliado" class="col s12 center">
            <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/bidder_login')); ?>">
                <?php echo e(csrf_field()); ?>

                <div class="row">
                    <div class="input-field col s12">
                        <i class="material-icons prefix blue-text">email</i>
                        <input type="text" id="emailO" name="email" class="autocomplete" value="<?php echo e(old('email')); ?>" required autofocus>
                        ...
                        <?php $__currentLoopData = session('flash_notification', collect())->toArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="help-block" style="color: red;">
                                <strong><?php echo e($message['message']); ?></strong>
                            </span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="input-field col s12">
                        ...
                        <!--
                        <a class="blue-text" href="<?php echo e(url('')); ?>">Olvide mi contraseña </a>
                        -->
                    </div>
                </div>
            </form>
