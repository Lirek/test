...
<div id="wrapper" class="main-navigation ">
    ...
    <nav class="navbar-default">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('plugins/img/Logo-Leipel.png')); ?>"
    ...
    <img src="<?php echo e(asset('plugins/img/piñas.jpg')); ?>" style="  background-size: cover; position: absolute; width: 100%; height: 100% ">
...
<div class="col-lg-12" style="background-color: #21a4de" >
    <div class="text-center">
            <center>
                <img height="60px" style="padding: 0% 3%" src="<?php echo e(asset('plugins/img/logo-icon-2.png')); ?>">
                <img height="60px" style="padding: 0% 3%" src="<?php echo e(asset('plugins/img/logo-icon-4.png')); ?>">
                <img height="60px" style="padding: 0% 3%" src="<?php echo e(asset('plugins/img/logo-icon.png')); ?>">
                <img height="60px" style="padding: 0% 3%" src="<?php echo e(asset('plugins/img/logo-icon-5.png')); ?>">
                <img height="60px" style="padding: 0% 3%" src="<?php echo e(asset('plugins/img/logo-icon-3.png')); ?>">
            </center>
    </div>
</div>
</footer>
