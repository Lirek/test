            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('ApplysSubmit')); ?>" id="form">
                            ...
                            <div class="form-group<?php echo e($errors->has('tlf') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="tlf" type="text" class="form-control" name="tlf" value="<?php echo e(old('tlf')); ?>" required="required" onpaste="return false">
                                    <?php if($errors->has('tlf')): ?>
                                        <span class="help-block">
