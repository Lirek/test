                ...
                <div class="card-panel curva">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col m6 s12">
                            ...
                            <?php echo Form::select('status_series',['1'=>'En Emisión', '2'=>'Finalizado'],$s,['class'=>'form-control', 'required'=>'required', 'oninvalid'=>"this.setCustomValidity('Seleccione una ppción')",'oninput'=>"setCustomValidity('')", 'id'=>'exampleInputFile']); ?>
                        ...
                        <div class="input-field col m6 s12">
                            ...
                            <?php if($serie->status != 'Aprobado'): ?>
                            <?php echo Form::number('cost',$serie->cost,['class'=>'form-control','placeholder'=>'Ingrese el costo en tickets', 'required'=>'required', 'id'=>'precio', 'oninvalid'=>"this.setCustomValidity('Escriba el costo en tickets')", 'oninput'=>"setCustomValidity('')", 'min'=>'0', 'oninput'=>"maxLengthCheck(this)"]); ?>
                        ...
                        <div class="input-field col m6 s12">
                            ...
                            <?php echo Form::textarea('story',$serie->story,['class'=>'materialize-textarea','rows'=>'5','cols'=>'2','placeholder'=>'Historia de la serie','required'=>'required','oninvalid'=>"this.setCustomValidity('Escriba una historia de la serie')", 'oninput'=>"setCustomValidity('')",'id'=>'historia']); ?>
                                ...
                                <div class="row group">
                                    <?php $__currentLoopData = $episodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="input-field col m6 s12">
                                            ...
                                            <label for="exampleInputPassword1" class="control-label">Costo en tickets</label>
                                            <?php if($serie->status != 'Aprobado'): ?>
                                            <input type="number" value="<?php echo e($e->cost); ?>" name="episodio_cost[]" id="precioEpisodio" class="form-control" placeholder="Ingrese el costo en tickets" min="0" required="required" oninvalid="this.setCustomValidity('Escriba el costo en tickets')" oninput="setCustomValidity('')" oninput="maxLengthCheck(this)">
                                            <?php else: ?>
                                       ...
                                       <div class="input-field col m6 s12">
                                            ...
                                            <textarea name="sinopsis[]" id="sinopsis" cols="3" rows="5" class="materialize-textarea" placeholder="Sinopsis del episodio" required="required" oninvalid="this.setCustomValidity('Escriba una sinopsis')" oninput="setCustomValidity('')"><?php echo e($e->sinopsis); ?></textarea>
                                            <br>
                                        </div>
